...
int main(int argc, char *argv[]) {
  ...
  players.push_back(new NetworkPlayer(mouseClickHumanMoveLogicalPositionProvider, BLACK));
  players.push_back(new NetworkPlayer(mouseClickHumanMoveLogicalPositionProvider, WHITE));
